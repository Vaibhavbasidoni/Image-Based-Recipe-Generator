...
(function ($, window, document, undefined) {
  var Carousel = {
    init: function (options, el) {
      var base = this;
      base.options = base.userOptions = $.extend(
        {},
    ...
    max: function () {
      ...
      var maximum =
        base.itemsAmount * base.itemWidth - base.options.items * base.itemWidth;
      maximum = maximum * -1;
    ...
    clearTransStyle: function (item, classToRemove) {
      var base = this;
      item
        .attr("style", item.data("owl-originalStyles"))
  ...
  var dateTimePicker = function (element, options) {
    var picker = {},
      ...
      getTimePickerMainTemplate = function () {
        ...
        if (isEnabled("h")) {
          topRow.append(
            $("<td>").append(
              $("<a>")
                .attr({ href: "#", tabindex: "-1", title: "Increment Hour" })
                .addClass("btn")
          ...
          bottomRow.append(
            $("<td>").append(
              $("<a>")
                .attr({ href: "#", tabindex: "-1", title: "Decrement Hour" })
                .addClass("btn")
        ...
        if (isEnabled("m")) {
          ...
          topRow.append(
            $("<td>").append(
              $("<a>")
                .attr({ href: "#", tabindex: "-1", title: "Increment Minute" })
                .addClass("btn")
        ...
        if (isEnabled("s")) {
          ...
          topRow.append(
            $("<td>").append(
              $("<a>")
                .attr({ href: "#", tabindex: "-1", title: "Increment Second" })
                .addClass("btn")
          ...
          bottomRow.append(
            $("<td>").append(
              $("<a>")
                .attr({ href: "#", tabindex: "-1", title: "Decrement Second" })
                .addClass("btn")
      ...
      getToolbar = function () {
        ...
        if (!options.sideBySide && hasDate() && hasTime()) {
          row.push(
            $("<td>").append(
              $("<a>")
                .attr({ "data-action": "togglePicker", title: "Select Time" })
      ...
      place = function () {
        ...
        widget.css({
          ...
          bottom:
            vertical === "top" ? position.top + element.outerHeight() : "auto",
          left:
            horizontal === "left"
              ? parent === element
                ? 0
    ...
    picker.format = function (newFormat) {
      ...
      if (
        ...
        throw new TypeError(
          "format() expects a sting or boolean:false parameter " + newFormat
        );
      }
    ...
    picker.defaultDate = function (defaultDate) {
      ...
      if (
        ...
        (input.val().trim() === "" && input.attr("placeholder") === undefined)
      ) {
